...
const VITE_STRIPE_PUBLISHABLE_KEY = import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY || 'pk_test_placeholder_key';

// Initialize Stripe
const stripePromise = VITE_STRIPE_PUBLISHABLE_KEY && VITE_STRIPE_PUBLISHABLE_KEY !== 'pk_test_placeholder_key' 
