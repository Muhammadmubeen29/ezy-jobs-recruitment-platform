...
const socials = [
  {
    href: 'https://www.facebook.com/EZYJOBS',
    label: 'Facebook',
    Icon: FaFacebook,
  },
  {
    href: 'https://www.instagram.com/EZYJOBS',
    label: 'Instagram',
    Icon: FaInstagram,
  },
  {
    href: 'https://www.linkedin.com/company/EZYJOBS',
    label: 'LinkedIn',
    Icon: FaLinkedin,
  },
  { href: 'https://www.x.com/EZYJOBS', label: 'Twitter', Icon: FaTwitter },
];
        ...
        <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
          ...
          <div className="flex flex-col items-center space-y-2 md:flex-row md:space-x-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-sm font-medium text-light-text dark:text-dark-text md:text-base">
              <span>&copy; {new Date().getFullYear()} EZYJOBS.</span>
