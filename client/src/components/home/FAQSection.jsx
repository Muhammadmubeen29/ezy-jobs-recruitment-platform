...
export default function FAQSection() {
  ...
  const faqs = [
    {
      id: 1,
      question: 'What is EZYJOBS?',
      answer:
        'EZYJOBS is an AI-powered recruitment platform that connects recruiters with expert interviewers and candidates. We use machine learning to shortlist top candidates and facilitate professional interviews.',
      category: 'general',
    },
    {
      id: 2,
      question: 'How much does EZYJOBS cost?',
      answer:
        'EZYJOBS charges a 2.5% platform fee on successful contracts between recruiters and interviewers. Registration is free for all users with no hidden costs or subscription fees.',
      category: 'general',
    },
    {
      id: 3,
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mb-12 text-center lg:mb-16">
          ...
          <p className="mx-auto max-w-3xl text-lg text-light-text/80 dark:text-dark-text/80 sm:text-xl">
            Find answers to the most common questions about EZYJOBS. Can&apos;t
        ...
        <div className="text-center">
          <div className="rounded-2xl border border-light-border/20 bg-gradient-to-r from-light-surface/30 to-light-surface/20 p-6 backdrop-blur-sm dark:border-dark-border/20 dark:from-dark-surface/30 dark:to-dark-surface/20 lg:p-8">
            ...
            <p className="mb-6 text-light-text/70 dark:text-dark-text/70">
              Our support team is here to help you get the most out of EZYJOBS
            </p>

            <a
              href="mailto:EZYJOBS@gmail.com"
