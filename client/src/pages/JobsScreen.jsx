...
export default function JobsScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>Browse Jobs - EZYjobs | Find Your Perfect Career Match</title>
        <meta
          name="description"
          content="Explore career opportunities on EZYjobs. Discover jobs matched to your skills with AI-powered recommendations and easy applications."
        />
        <meta
          name="keywords"
          content="EZYjobs Jobs, Career Opportunities, Job Search, AI Job Matching, Employment, Career Growth"
        />
      </Helmet>
