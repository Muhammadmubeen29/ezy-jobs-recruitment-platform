...
export default function DashboardScreen() {
  ...
  useEffect(() => {
    ...
    if (users?.users) {
      ...
      const userData = Object.keys(userTypeCounts).map((key) => ({
        name: key,
        value: userTypeCounts[key],
      }));
      ...
      <section className="flex min-h-screen animate-fadeIn flex-col items-center bg-light-background px-4 py-24 dark:bg-dark-background">
        {overallLoading ? (
          ...
          <div className="mx-auto w-full max-w-7xl">
            ...
            <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
              <div className="animate-slideUp rounded-xl bg-light-surface p-5 shadow-md transition-all hover:shadow-lg dark:bg-dark-surface">
                <div className="flex items-center justify-between">
                  ...
                  <div className="rounded-lg bg-blue-100 p-3 dark:bg-blue-900/30">
                    <FaUsers className="text-xl text-light-primary dark:text-dark-primary" />
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="rounded-lg bg-green-100 p-3 dark:bg-green-900/30">
                    <FaDollarSign className="text-xl text-green-500 dark:text-green-400" />
                  </div>
                </div>
                <div className="mt-4 border-t border-light-border pt-4 dark:border-dark-border">
                  <p className="text-xs text-light-text/60 dark:text-dark-text/60">
            ...
            {/* Updated Charts Layout - Different sized charts organized by category */}
            <div className="mb-8 grid grid-cols-1 gap-8">
              ...
              <div className="rounded-xl bg-light-surface p-6 shadow-md transition-all hover:shadow-lg dark:bg-dark-surface">
                <h3 className="mb-4 flex items-center text-xl font-bold text-light-text dark:text-dark-text">
                  <FaDollarSign className="mr-2 text-green-500" /> Monthly
                  Revenue Trend
                </h3>
                <div className="h-96">
              ...
              {/* User distribution and application status - Two columns */}
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                {/* User Types Distribution */}
                <div className="rounded-xl bg-light-surface p-6 shadow-md transition-all hover:shadow-lg dark:bg-dark-surface">
                  <h3 className="mb-4 flex items-center text-xl font-bold text-light-text dark:text-dark-text">
                    <FaUsers className="mr-2 text-light-primary" /> User Role
                    Distribution
                  </h3>
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
              ...
              {/* Three column metrics for jobs, applications and interviews */}
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                {/* Job Categories (Horizontal Bar Chart) */}
                <div className="rounded-xl bg-light-surface p-6 shadow-md transition-all hover:shadow-lg dark:bg-dark-surface">
                  <h3 className="mb-4 flex items-center text-xl font-bold text-light-text dark:text-dark-text">
              ...
              {/* Two column layout for contract and rating data */}
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              {/* Final row - two charts showing status metrics */}
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                {/* User Verification Status */}
                <div className="rounded-xl bg-light-surface p-6 shadow-md transition-all hover:shadow-lg dark:bg-dark-surface">
                  <h3 className="mb-4 flex items-center text-xl font-bold text-light-text dark:text-dark-text">
                    <FaUsers className="mr-2 text-light-primary" /> User
                    Verification Status
                  </h3>
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
