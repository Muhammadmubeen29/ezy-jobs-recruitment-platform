...
// Enhanced PDF styles with professional EZY Jobs branding
          ...
          <View style={styles.headerContainer}>
            <View style={styles.logoSection}>
              ...
              <View style={styles.brandInfo}>
                <Text style={styles.companyName}>EZY Jobs</Text>
                <Text style={styles.tagline}>
                  Making Job Search Easy
                </Text>
              </View>
            </View>
            <View style={styles.contactSection}>
              <Text style={styles.contactInfo}>contact@ezyjobs.com</Text>
              <Text style={styles.contactInfo}>www.ezyjobs.com</Text>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.disclaimer}>
            <Text style={styles.disclaimerText}>
              ...
              EZY Jobs&apos; advanced analytics engine based on platform data
              ...
              please contact our analytics team at analytics@ezyjobs.com. Data
        ...
        <View style={styles.footer}>
          <View style={styles.footerRow}>
            <Text style={styles.footerBrand}>
              EZY Jobs - Making Job Search Easy &copy;{' '}
...
export default function ReportsScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Analytics & Reports [Admin] - EZY Jobs | Platform Insights
        </title>
        <meta
          name="description"
          content="EZY Jobs Analytics & Reports - Generate comprehensive reports and insights on platform performance, user activity, and recruitment metrics."
        />
        <meta
          name="keywords"
          content="EZY Jobs Reports, Recruitment Analytics, Platform Insights, Performance Reports, Admin Analytics"
        />
      </Helmet>
              ...
              <div className="flex flex-col items-start justify-between gap-4 rounded-xl bg-light-surface p-6 shadow-md dark:bg-dark-surface sm:flex-row">
                ...
                <div>
                  ...
                  <PDFDownloadLink
                    ...
                    fileName={`EZYJobs_${(reportData?.reportType || 'Report').replace(/\s+/g, '_')}_${startDate}_${endDate}.pdf`}
