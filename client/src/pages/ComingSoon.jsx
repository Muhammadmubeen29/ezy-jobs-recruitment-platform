...
export default function ComingSoon({
  ...
  return (
    <>
      <Helmet>
        <title>Coming Soon - EZYjobs | New Features in Development</title>
        <meta
          name="description"
          content="Exciting new features coming to EZYjobs. Stay tuned for enhanced AI recruitment capabilities and improved user experience."
        />
        <meta
          name="keywords"
          content="EZYjobs Coming Soon, New Features, AI Recruitment Updates, Platform Development"
        />
      </Helmet>
