...
function ResumeScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>My Resume - EZYjobs | Professional Resume Builder</title>
        <meta
          name="description"
          content="Create and manage your professional resume on EZYjobs. Optimize your profile for AI-powered job matching and better opportunities."
        />
        <meta
          name="keywords"
          content="EZYjobs Resume, Professional Resume, Resume Builder, Career Profile, Skills Profile, AI Matching"
        />
      </Helmet>
