...
function ProfileScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>My Profile - EZYjobs | Manage Your Professional Profile</title>
        <meta
          name="description"
          content="Manage your EZYjobs profile. Update personal information, preferences, and optimize your presence on the recruitment platform."
        />
        <meta
          name="keywords"
          content="EZYjobs Profile, User Profile, Professional Profile, Account Settings, Personal Information"
        />
      </Helmet>
