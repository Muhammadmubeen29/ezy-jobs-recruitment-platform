...
export default function ContractsScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>My Contracts - EZYJobs | Manage Interview Contracts</title>
        <meta
          name="description"
          content="Manage your interview contracts on EZYJobs. Track payments, contract status, and build long-term recruiter relationships."
        />
        <meta
          name="keywords"
          content="EZYJobs Interviewer Contracts, Interview Payments, Contract Management, Freelance Contracts, Interview Business"
        />
      </Helmet>
