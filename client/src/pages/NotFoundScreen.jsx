...
export default function NotFoundScreen() {
  ...
  return (
    <>
      <Helmet>
        <title>Page Not Found - EZYjobs | 404 Error</title>
        <meta
          name="description"
          content="Page not found on EZYjobs. The requested page doesn't exist. Return to our AI-powered recruitment platform."
        />
        <meta
          name="keywords"
          content="EZYjobs 404, Page Not Found, Error Page, EZYjobs Navigation"
        />
      </Helmet>
