# EZY Jobs - Optimizing Your Recruitment Journey

>The project aims to develop a comprehensive web application that leverages AI and Machine Learning technologies to optimize the recruitment process for businesses and professionals. The project is developed using the MERN stack (MongoDB, Express.js, React.js, Node.js) with Python-based AI services and various other modern technologies.

<br/>
<div align="center">
   <a href="https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform">
      <img src="./client/src/assets/images/logo.png" alt="Logo" width="100" height="100">
   </a>

   <h3 align="center">EZY Jobs</h3>

   <p align="center">
      AI-Powered Recruitment Platform with Intelligent Candidate Matching
      <br/>
      <br/>
      <a href="https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform"><strong>Explore the docs »</strong></a>
      <br/>
      <br/>
      <a href="https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/issues">Report Bug</a>
      .
      <a href="https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/issues">Request Feature</a>
   </p>
</div>

## Table Of Contents

- [EZY Jobs - Optimizing Your Recruitment Journey](#ezy-jobs---optimizing-your-recruitment-journey)
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform.git

   cd ezy-jobs-recruitment-platform
   ```
...
- **Production:** [https://ezy-jobs-server.herokuapp.com/api-docs](https://ezy-jobs-server.herokuapp.com/api-docs)
...
- **Backend**: Heroku with MongoDB database
...
- If you have suggestions for adding or removing projects, feel free to [open an issue](https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/issues/new) to discuss it, or directly create a pull request after you edit the _README.md_ file with necessary changes.
- Please make sure you check your spelling and grammar.
- Create individual PR for each suggestion.
- Please also read through the [Code Of Conduct](https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/blob/master/CODE_OF_CONDUCT.md) before posting your first idea as well.
...
- **Mubeen Mukhtar** - Full Stack Developer & Project Lead - [mubeenmukhtar](https://github.com/mubeenmukhtar) - _Frontend, Backend, AI/ML, and Deployment_



[contributors-shield]: https://img.shields.io/github/contributors/mubeenmukhtar/ezy-jobs-recruitment-platform.svg?style=for-the-badge
[contributors-url]: https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/mubeenmukhtar/ezy-jobs-recruitment-platform.svg?style=for-the-badge
[forks-url]: https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/network/members
[stars-shield]: https://img.shields.io/github/stars/mubeenmukhtar/ezy-jobs-recruitment-platform.svg?style=for-the-badge
[stars-url]: https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/stargazers
[issues-shield]: https://img.shields.io/github/issues/mubeenmukhtar/ezy-jobs-recruitment-platform.svg?style=for-the-badge
[issues-url]: https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/issues
[license-shield]: https://img.shields.io/github/license/mubeenmukhtar/ezy-jobs-recruitment-platform.svg?style=for-the-badge
[license-url]: https://github.com/mubeenmukhtar/ezy-jobs-recruitment-platform/blob/main/LICENSE.md
