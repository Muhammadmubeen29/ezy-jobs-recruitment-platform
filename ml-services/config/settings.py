...
class AppConfig:
    ...
    def __init__(self):
        ...
        if self.FLASK_ENV == "production":
            self.CLIENT_URL = os.getenv(
                "PROD_CLIENT_URL", "https://ezy-jobs-client.vercel.app"
            )
            self.NODE_SERVER_URL = os.getenv(
                "PROD_NODE_SERVER_URL",
                "https://ezy-jobs-server.herokuapp.com",
            )
        else:
    ...
    def _parse_cors_origins(self):
        ...
        if cors_env:
            ...
            return [
                "https://ezy-jobs-client.vercel.app",
                "https://ezy-jobs-develop-client.vercel.app",
                "http://localhost:5173",
                "http://localhost:5000",
            ]
