...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const resumeData = {
    ...
    summary: 'Professional seeking opportunities in the recruitment industry.',
    headline: 'Experienced Professional',
    skills: ['Communication', 'Problem Solving'],
    experience: 'Professional experience in various industries.',
    education: 'Educational background in relevant field.',
    industry: 'Technology',
    availability: 'Immediate',
    company: 'Previous Company',
    achievements: 'Various professional achievements.',
    portfolio: null,
  ...
  const isEmailSent = await sendEmail(res, {
    ...
    to: user.email,
    subject: 'Welcome to EZY Jobs - Verify Your Email',
...
const forgotPassword = asyncHandler(async (req, res) => {
  ...
  const isEmailSent = await sendEmail(res, {
    from: process.env.NODEMAILER_SMTP_EMAIL,
    to: user.email,
    subject: 'EZY Jobs - Reset Your Password',
    html: generateEmailTemplate({
      firstName: user.firstName,
      subject: 'EZY Jobs - Reset Your Password',
      content: [
        ...
        },
        {
          type: 'text',
          value:
            'You recently requested to reset your password for your EZY Jobs account. Use the OTP below to reset it:',
        },
        {
          type: 'otp',
        ...
        },
        {
          ...
          value: [
            ...
            'EZY Jobs staff will never ask for your OTP',
            "Always ensure you're on the official EZY Jobs website before entering credentials",
...
const resetPassword = asyncHandler(async (req, res) => {
  ...
  const isEmailSent = await sendEmail(res, {
    from: process.env.NODEMAILER_SMTP_EMAIL,
    to: user.email,
    subject: 'EZY Jobs - Password Reset Successful',
    html: generateEmailTemplate({
      firstName: user.firstName,
      subject: 'EZY Jobs - Password Reset Successful',
      content: [
...
const regenerateOTP = asyncHandler(async (req, res) => {
  ...
  //   from: process.env.NODEMAILER_SMTP_EMAIL,
  //   to: user.email,
  //   subject: 'EZY Jobs - Your New Verification Code',
  //   html: generateEmailTemplate({
  //     firstName: user.firstName,
  //     subject: 'EZY Jobs - Your New Verification Code',
