  ...
  async up(queryInterface, Sequelize) {
    ...
    const existingData = await queryInterface.sequelize.query(
      `SELECT email, phone FROM "Users"
       WHERE email IN (
         'admin@ezyjobs.com',
         'recruiter@ezyjobs.com', 
         'interviewer@ezyjobs.com',
         'interviewer2@ezyjobs.com',
         'candidate@ezyjobs.com',
         'candidate2@ezyjobs.com'
       );`,
    ...
    const insertedUsers = await queryInterface.sequelize.query(
      `SELECT id, email, "isRecruiter", "isInterviewer", "isCandidate", "createdAt" 
       FROM "Users" 
       WHERE email NOT IN ('admin@ezyjobs.com', 'recruiter@ezyjobs.com', 'interviewer@ezyjobs.com', 'interviewer2@ezyjobs.com', 'candidate@ezyjobs.com', 'candidate2@ezyjobs.com')
