...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.NODEMAILER_SMTP_USER,
    pass: process.env.NODEMAILER_SMTP_PASS, // MUST be App Password
  },
});
...
const sendEmail = asyncHandler(async (optionsOrRes, maybeOptions) => {
  // Support two calling patterns used across the codebase:
  // sendEmail(options) and sendEmail(res, options)
  const options = maybeOptions || optionsOrRes;
...
const generateEmailTemplate = ({ firstName, subject, content = [] }) => {
  ...
  <html lang="en">
    <head>
      ...
      <meta name="apple-mobile-web-app-title" content="EZY Jobs" />
    ...
    <body>
      <div class="container" role="main">
        ...
        <main>
          ...
          <p class="content">Thank you for choosing EZY Jobs. If you have any questions or need further assistance, please don't hesitate to contact us at <a href="mailto:support@ezyjobs.com" style="color: var(--primary); text-decoration: none">support@ezyjobs.com</a>.</p>
          <p class="content">Best Regards,<br />The EZY Jobs Team</p>
        </main>
